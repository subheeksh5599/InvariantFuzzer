      ...
      <div className="relative mx-auto max-w-7xl overflow-hidden rounded-3xl bg-muted/50">
        <div className="relative z-10 px-8 py-12 sm:px-12">
          <div className="max-w-xl">
            ...
            <div className="mt-8">
              <p className="mb-3 text-xs font-medium text-muted-foreground">Install via the Solana AI Kit:</p>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <Link
                href="https://github.com/subheeksh5599/solana-invariant-fuzzer/blob/main/README.md"
                target="_blank"
